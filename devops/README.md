...
```
DEPLOY_ENV=prod
DEPLOY_HOST=plone-vercel-test.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    plone-vercel-test.example.com:
      ansible_user: root
      host: plone-vercel-test
      hostname: plone-vercel-test.example.com
```
...
Deploy the stack defined in `devops/stacks/plone-vercel-test.example.com.yml` to the remote server with:
