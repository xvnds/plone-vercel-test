...
2. Go to your repository at [collective/plone-vercel-test](https://github.com/collective/plone-vercel-test).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `plone-vercel-test.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | plone-vercel-test.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | plone-vercel-test.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/plone-vercel-test/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/plone-vercel-test/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/plone-vercel-test-backend`) and Frontend (`ghcr.io/collective/plone-vercel-test-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of plone-vercel-test.example.com](https://github.com/collective/plone-vercel-test/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/plone-vercel-test.example.com.yml` stack.
